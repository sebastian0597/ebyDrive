...
const review = 'Lorem ipsum dolor sit amet, consectetur adipiscing elit amiPharetra in elementum duis justo nulla';
...
const UserRatingsScreen = ({ navigation }) => {
    return (
    ...
    function userRatings() {
        const renderItem = ({ item, index }) => (
            <View style={{ marginHorizontal: Sizes.fixPadding * 2.0, }}>
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                    ...
                    <View style={{ flex: 1, marginLeft: Sizes.fixPadding + 5.0, }}>
                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                            <Text numberOfLines={1} style={{ flex: 1, marginRight: Sizes.fixPadding + 5.0, ...Fonts.blackColor16SemiBold }}>
                                {item.userName}
                            </Text>
                            <View style={styles.ratingWrapStyle}>
                                <Text style={{ marginRight: Sizes.fixPadding - 5.0, ...Fonts.whiteColor12Bold }}>
                ...
                <Text numberOfLines={2} style={{ marginTop: Sizes.fixPadding, ...Fonts.grayColor14SemiBold }}>
                    {item.ratingDescription}
                </Text>
                {
                    index == userRatingsList.length - 1
                        ?
                        null
                        :
